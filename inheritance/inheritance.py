...
# Load configuration
config = uConfig("inheritance.ini")
...
# Perform test
print ('-' * 66)
test = config.GetSection("Test")
print (test.FormatString("ColorList is [=ColorList]"))
print (test.FormatString("BaseColorList is [=BaseColorList]"))
